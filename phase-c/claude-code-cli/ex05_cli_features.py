...
def main() -> None:
    ...
    print("KEY FINDINGS")
    print("=" * 60)
    print("  CLI-only features (NOT in SDK):")
    print("    • TodoWrite — task tracking (always available in CLI)")
    print("    • Auto memory — ~/.claude/projects/.../memory/")
    print("    • Agent teams — multi-instance coordination")
    print("    • Interactive mode — /plan, /resume, /compact, etc.")
    print("    • --worktree — git worktree per session")
    print("    • --continue / --resume — session continuation")
    print("  Available in BOTH CLI and SDK:")
    print("    • --tools / allowed_tools")
    print("    • --json-schema / output_format")
    print("    • --agents / agents param")
