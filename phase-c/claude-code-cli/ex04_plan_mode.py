...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="c1_cli_ex04a_") as tmpdir:
        ...
        print("  → Plan mode = no tool execution. Claude describes what it WOULD do.")
    ...
    print("KEY FINDINGS")
    print("=" * 60)
    print("  • --permission-mode plan: blocks ALL tool execution (same as SDK)")
    print("  • Claude outputs what it WOULD do, but cannot execute anything")
    print("  • There is no plan-then-execute workflow in CLI either")
    print("  • --effort controls thinking depth, not planning behavior")
    print("  • In interactive mode, /plan toggles plan mode on/off")
